...
router.post("/create", upload.fields([
    ...
    try {
        ...
        const { category_id,vendor_id,location_description,location_lat,location_lang,title, description,host_name,city_id,area,date,full, } = req.body;
        ...
        const newEvent = new Event({
            category_id,vendor_id,location_description,location_lat,location_lang,title, description,host_name,city_id,area,date,full,
            img: imgPath,
            img1: imgPath1,
            img2: imgPath2,
            img3: imgPath3,
...
router.post("/edit/:id", upload.fields([
    ...
    try {
        ...
        const { category_id, vendor_id, location_description, location_lat, location_lang, title, description, host_name,is_active ,city_id,area,date,full} = req.body;
